...
public class TacGiaDAO implements DAOInterface<TacGia>{
	...
	public TacGia selectById(TacGia t) {
		...
		try {
			...
			PreparedStatement st = con.prepareStatement(sql);
			st.setString(1, t.getMaTacgiaString());
	...
	public int insert(TacGia t) {
		...
		try {
			...
			PreparedStatement st = con.prepareStatement(sql);
			st.setString(1, t.getMaTacgiaString());
			st.setString(2, t.getHoVaTenString());
			st.setDate(3, t.getNgaySing());
			st.setString(4, t.getTieuSuString());
	...
	public int update(TacGia t) {
		...
		try {
			...
			st.setDate(2, t.getNgaySing());
			st.setString(3, t.getTieuSuString());
			st.setString(4, t.getMaTacgiaString());
			// Bước 3: thực thi câu lệnh SQL
