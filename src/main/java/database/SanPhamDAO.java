...
public class SanPhamDAO implements DAOInterface<SanPham> {
	...
	public int insert(SanPham t) {
		...
		try {
			...
			PreparedStatement st = con.prepareStatement(sql);
			st.setString(1, t.getMaSanPham());
			st.setString(2, t.getTenSanPhamString());
			st.setString(3, t.getTacGia().getMaTacgiaString());
			...
			st.setString(9, t.getTheLoai().getMaTheLoaiString());
			st.setString(10, t.getNgonNgu());
			st.setString(11, t.getMoTaString());
